...
(() => {
  ...
  function ensureSpreadsheetEditor() {
    ...
    spreadsheetEditLoadPromise = Promise.all([
      ...
      loadScriptOnce("./spreadsheet_sort.js?v=spreadsheet-sort-1", "data-pqnas-spreadsheet-sort-js"),
      ...
      return loadScriptOnce("./spreadsheet_edit.js?v=spreadsheet-sort-1", "data-pqnas-spreadsheet-edit-js");
    }).then(() => {
