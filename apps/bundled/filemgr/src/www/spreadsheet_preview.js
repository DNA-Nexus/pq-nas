...
(() => {
  ...
  function ensureSpreadsheetEditor() {
    ...
    spreadsheetEditLoadPromise = Promise.all([
      loadStyleOnce("./spreadsheet_edit.css?v=spreadsheet-image-move-1", "data-pqnas-spreadsheet-edit-css"),
      ...
      loadScriptOnce("./spreadsheet_xlsx_images.js?v=spreadsheet-imported-image-move-1", "data-pqnas-spreadsheet-xlsx-images-js"),
      loadScriptOnce("./spreadsheet_image_overlay.js?v=spreadsheet-image-move-1", "data-pqnas-spreadsheet-image-overlay-js")
    ]).then(() => {
      return loadScriptOnce("./spreadsheet_edit.js?v=spreadsheet-imported-image-move-1", "data-pqnas-spreadsheet-edit-js");
    }).then(() => {
