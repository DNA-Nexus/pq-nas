...
(() => {
  ...
  function ensureSpreadsheetEditor() {
    ...
    spreadsheetEditLoadPromise = Promise.all([
      loadStyleOnce("./spreadsheet_edit.css?v=spreadsheet-keyboard-entry-2", "data-pqnas-spreadsheet-edit-css"),
      loadScriptOnce("./spreadsheet_edit.js?v=spreadsheet-keyboard-entry-2", "data-pqnas-spreadsheet-edit-js")
    ]).then(() => {
