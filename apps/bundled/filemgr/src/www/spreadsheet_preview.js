...
(() => {
  ...
  function ensureSpreadsheetEditor() {
    ...
    spreadsheetEditLoadPromise = Promise.all([
      ...
      loadScriptOnce("./spreadsheet_formula_references.js?v=spreadsheet-cross-sheet-picker-1", "data-pqnas-spreadsheet-formula-references-js"),
      loadScriptOnce("./spreadsheet_formula_reference_picker.js?v=spreadsheet-cross-sheet-range-picker-1", "data-pqnas-spreadsheet-formula-reference-picker-js"),
      ...
      return loadScriptOnce("./spreadsheet_edit.js?v=spreadsheet-cross-sheet-range-picker-1", "data-pqnas-spreadsheet-edit-js");
    }).then(() => {
